    ...
    public static class Sudokus
    {
        public static IEnumerable<Sudoku> MockData()
        {
            List<Sudoku> sudokuList = new List<Sudoku>
                ...
                {
                    SudokuId = 4,
                    Name = "Solve Hardest (2)",
                    Cells = new int[][]
                    {
                        new int[9] {1,0,0,0,0,7,0,9,0 },
                        new int[9] {0,3,0,0,2,0,0,0,8 },
                        new int[9] {0,0,9,6,0,0,5,0,0 },
                        new int[9] {0,0,5,3,0,0,9,0,0 },
                        new int[9] {0,1,0,0,8,0,0,0,2 },
                        new int[9] {6,0,0,0,0,4,0,0,0 },
                        new int[9] {3,0,0,0,0,0,0,1,0 },
                        new int[9] {0,4,0,0,0,0,0,0,7 },
                        new int[9] {0,0,7,0,0,0,3,0,0 }
                    }
                }
            };
